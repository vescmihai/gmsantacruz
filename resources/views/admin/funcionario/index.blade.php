  ...
  <div class="row">
      ...
      <div class="position-sticky pt-3">
        <ul class="nav flex-column">
          ...
          @if ($user->rol->name == 'admin')
            <li class="nav-item">
              <a class="nav-link active" href="{{ route('admin.funcionarios') }}">
                Funcionarios
              </a>
            </li>
          @endif
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <div class="d-flex flex-row m-2 mb-3">
        <a href="{{ route('admin.funcionarios.create') }}" class="btn btn-primary">Agregar Funcionario <i class="bi bi-check-circle-fill"></i></a>
      </div>
